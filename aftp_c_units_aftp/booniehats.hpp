class AFTP_booniehat_wz93 : H_Booniehat_khk_hs {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_wz93.paa"};
	...
	class AFTP_booniehat_wzd93 : AFTP_booniehat_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_wzd93.paa"};
	...
	class AFTP_booniehat_aau : AFTP_booniehat_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_aau.paa"};
	...
	class AFTP_booniehat_afg : AFTP_booniehat_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_afg.paa"};
	...
	/*
	class AFTP_booniehat_ale : AFTP_booniehat_wz93 {
		displayname = "AFTP Booniehat A-TACS LE";
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_ale.paa"};
		picture = "\AFTP_units\data\ico_booniehat_ale.paa";
		author = "AFTP Golas & Waffel";
		scope = public;
	...
	*/
	...
	class AFTP_booniehat_mc : AFTP_booniehat_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_mc.paa"};
	...
	class AFTP_booniehat_mct : AFTP_booniehat_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\booniehat_mct.paa"};

class	AFTP_patrolcap_wz93 : H_MilCap_gry {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_wz93.paa"};
	...
	class	AFTP_patrolcap_wzd93 : AFTP_patrolcap_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_wzd93.paa"};
	...
	class	AFTP_patrolcap_aau : AFTP_patrolcap_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_aau.paa"};
	...
	class	AFTP_patrolcap_afg : AFTP_patrolcap_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_afg.paa"};
	...
	/*
	class	AFTP_patrolcap_ale : AFTP_patrolcap_wz93 {
		displayname = "AFTP Patrol Cap A-TACS LE";
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_ale.paa"};
		picture = "\AFTP_units\data\ico_patrolcap_ale.paa";
		author = "AFTP Golas & Waffel";
		scope = public;
	...
	*/
	...
	class	AFTP_patrolcap_mc : AFTP_patrolcap_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_mc.paa"};
	...
	class	AFTP_patrolcap_mct : AFTP_patrolcap_wz93 {
		...
		hiddenselectionstextures[] = {"aftp_units\data\patrolcap_mct.paa"};
